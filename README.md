...
* CanFulfillIntent Request Support [GitHub](https://raw.githubusercontent.com/stoiveyp/Alexa.NET.CanFulfillIntentRequest) / [NuGet](https://www.nuget.org/packages/Alexa.NET.CanFulfillIntentRequest)
